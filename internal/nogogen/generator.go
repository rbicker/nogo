...
var tmpl = template.Must(template.New("").Funcs(conv).Parse(`package nogo

import "github.com/rbicker/nogo"

// Code generated by github.com/rbicker/nogo; DO NOT EDIT.

// Dir returns a new nogo dir, which corresponds to http.FileSystem.
func Dir(name string) nogo.Dir {
	return nogo.Dir(name)
}
...
func Run() {
	...
	// create path for blob file
	p := filepath.Dir(targetFile)
	if _, err := os.Stat(p); os.IsNotExist(err) {
		log.Printf("creating path: %v", p)
